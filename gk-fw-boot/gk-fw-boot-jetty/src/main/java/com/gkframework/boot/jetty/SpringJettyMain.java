...
public class SpringJettyMain {
    ...
    public static void main(String[] args) {
        ...
        ApplicationContext applicationContext = 
        		new ClassPathXmlApplicationContext("classpath*:META-INF/acfun/ac-boot-jetty-spring.xml");
        ...
        try {
            ...
            ObjectName logOname = new ObjectName("tv.acframework.container:type=LogContainer");
